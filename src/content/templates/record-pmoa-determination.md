---
title: "Record: Primary Mode of Action (PMOA) Determination"
...
| Constituent | Mode of action | Contribution to the therapeutic effect |
|---|---|---|
...
| Item | Entry |
|---|---|
| Product | Drug-eluting coronary stent, single-entity |
...
| Most important therapeutic action | Keeping the vessel patent (the stent) |
| PMOA | Device |
| Lead center | CDRH |
| Application type | PMA |
| Base system | 21 CFR Part 820 / QMSR |
| Added provisions | The eight drug provisions of 4.4(b)(2); stability and expiration dating for the drug coating are the key new builds |
| RFD | Not required; PMOA clear. Determination rationale on file. |
