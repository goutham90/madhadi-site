...
- **Instrument category (USP <1058>)**: the risk-based grouping of instruments into Group A (standard apparatus, no independent qualification), Group B (standard instruments and apparatus), and Group C (computerized analytical instruments) that sets the depth of qualification.
