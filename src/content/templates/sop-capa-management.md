...
| Preventive actions / read-across | Review audit trail configuration on all 12 GMP computerized lab systems for the same default-reset exposure, validation, due 30 June 2026. Result: 2 additional systems found with the same issue, added to corrective scope. |
