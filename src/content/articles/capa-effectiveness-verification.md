...
- **FDA 21 CFR 820.100, Corrective and Preventive Action** (the Quality System Regulation for medical devices). Subpart (a)(4) requires "Verifying or validating the corrective and preventive action to ensure that such action is effective and does not adversely affect the finished device." Verifying or validating effectiveness is a named, mandatory step. Note: in early 2026 FDA's device quality system requirement is transitioning under the Quality Management System Regulation (QMSR, 21 CFR 820 amended to incorporate ISO 13485:2016), but the effectiveness expectation carries straight through. See [medical-device-quality-system-qmsr](/articles/medical-device-quality-system-qmsr).
- **21 CFR 211 (cGMP for finished pharmaceuticals)** does not use the literal phrase "effectiveness check," but 211.192 requires investigation of discrepancies and failures, and 211.22 gives the quality unit responsibility for ensuring those are resolved. FDA reads "resolved" to include confirmation that the action worked. The Part 211 walkthrough is at [cfr-210-211-cgmp-walkthrough](/articles/cfr-210-211-cgmp-walkthrough).
- **ICH Q10, Pharmaceutical Quality System (2008)** names CAPA as one of the four core process elements and states the company "should have a system for implementing corrective actions and preventive actions resulting from the investigation of complaints, product rejections, non-conformances, recalls, deviations, audits, regulatory inspections and findings, and trends... A structured approach to the investigation process should be used with the objective of determining root cause. The level of effort, formality and documentation of the investigation should be commensurate with the level of risk." The expectation of checking the result feeds the management review element. See [management-review-q10](/articles/management-review-q10) and [pharmaceutical-quality-system](/articles/pharmaceutical-quality-system).
...
- **ISO 14971:2019** ties into CAPA effectiveness when the action touches a risk control, because you have to confirm the control is effective and has not introduced a new hazard. See [iso-14971-risk-management-devices](/articles/iso-14971-risk-management-devices).
