...
- **EU GMP Annex 11** (Computerised Systems, in force 2011) section 12.4 expects the systems that manage data and documents to capture which operator entered, changed, confirmed, or deleted data, together with the date and time of each action. Annex 11 section 5 (Data) and the audit-trail expectations in section 9 also depend on reliable time.
