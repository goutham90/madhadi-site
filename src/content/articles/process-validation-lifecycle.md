...
Stage 2 occurs during manufacturing scale-up and commercial introduction. It demonstrates that the commercial-scale process consistently produces product meeting CQAs when operated within the defined CPP ranges.
...
**Process Performance Qualification (PPQ):** The combined Stage 2 activity where qualified equipment is operated with the actual product and process to demonstrate the entire system (facility, equipment, utilities, process) produces consistent, specification-meeting output.
...
The APR is a Stage 3 output. It demonstrates that the process remains validated through continuous oversight.
...
For expedited development pathways (Breakthrough Therapy, Accelerated Approval), FDA's 2011 guidance acknowledges that full PPQ may not be complete before initial licensure. A robust process monitoring program and commitment to provide additional validation data post-approval can be negotiated.
