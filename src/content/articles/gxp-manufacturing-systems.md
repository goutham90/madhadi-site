...
| Software assurance approach | FDA Computer Software Assurance for Production and Quality Management System Software (draft 2022 as "...Quality System Software"; final 24 September 2025) | Risk-based, least-burdensome assurance for non-product software, scripted vs unscripted testing |
| Production and quality-system software (combination products) | Before 2 February 2026, 21 CFR 820.70(i); under the QMSR (21 CFR 820 effective 2 February 2026) Part 820 incorporates ISO 13485:2016 by reference, so software validation sits under ISO 13485:2016 clause 4.1.6 with FDA-specific records at 820.35, and legacy 820.70 is reserved | Validation of software used in production or the quality system per its intended use |

Keep that table close. When an inspector asks "what requires this control," you cite the row, not a feeling. The last row matters for combination products: the same MES, SCADA, and LIMS platforms can fall under both the drug cGMPs in Part 211 and, on the device-constituent side, the QMSR. Note the version trap. Before 2 February 2026 the device-software requirement was 21 CFR 820.70(i); under the QMSR that section is reserved, and software validation now flows from ISO 13485:2016 clause 4.1.6 incorporated by reference, with FDA-specific records at 820.35. Citing 820.70(i) as the operative requirement after that date points an inspector at a reserved section.
