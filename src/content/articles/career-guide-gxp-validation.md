...
**ICH (International Council for Harmonisation)** produces harmonized technical guidelines adopted by FDA, EMA, and most global agencies. The quality guidelines you encounter most often are ICH Q10 (Pharmaceutical Quality System), ICH Q9(R1) (Quality Risk Management, R1 revision adopted 2023), and ICH Q7 (GMP for active pharmaceutical ingredients). The applied method for assessing and controlling risk is covered in [quality risk management](/articles/quality-risk-management).
