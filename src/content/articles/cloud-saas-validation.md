...
No single regulation says "validate your cloud." The obligation is assembled from several sources that all point the same way. In the United States, 21 CFR 211.68 requires that automated systems used in GMP be suitable for their intended use and routinely calibrated, inspected, or checked, and 21 CFR Part 11 (1997) governs electronic records and signatures wherever those records live. In the EU, EU GMP Annex 11 "Computerised Systems" (in force since 2011) sets the validation and third-party expectations, and Annex 11 clause 3 specifically governs suppliers and service providers. For combination products and any device-constituent work, 21 CFR 820.70(i) historically required validation of software used in production or the quality system. Under the Quality Management System Regulation (21 CFR 820 as amended February 2, 2024, effective February 2, 2026), legacy 820.70(i) is reserved and that requirement now sits in ISO 13485:2016 clause 7.5.6 (validation of software used in production and service provision) and clause 4.1.6 (validation of software used in the quality management system), incorporated into Part 820 by reference, so a reader checking the current obligation should look to the ISO clauses rather than the old Part 820 text. For clinical systems, ICH E6(R3) Good Clinical Practice (2025) and FDA's electronic systems guidance carry equivalent expectations. Cloud does not get a carve-out from any of these. It changes how you satisfy them.
...
EU GMP Annex 11, "Computerised Systems" (EudraLex Volume 4, in force since 2011), addresses third-party arrangements directly. Clause 3.1 carries a simple expectation: whenever an outside party is used for anything touching a computerised system or its data, whether that is supplying, installing, configuring, integrating, validating, maintaining (including remote access), modifying, or retaining the system or service, there has to be a formal written agreement between the manufacturer and that party, and the agreement has to spell out clearly what the third party is responsible for.
