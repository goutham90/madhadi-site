...
The RTM is the document that demonstrates your testing was complete — that every requirement in the URS was tested, and that every test executed traces back to a requirement. Without it, you can have a hundred test scripts and still not be able to demonstrate that the system does what it was supposed to do.
...
For Category 4 and 5 systems, the vendor's development practices and quality system affect the reliability of the software you're deploying. GAMP 5 supports leveraging supplier activities — if the vendor has a documented, auditable software development lifecycle, their testing and quality records can reduce the scope of the site validation effort.
