...
- **USP <1231> is informational; the specifications live in the monographs.** The **Purified Water** and **Water for Injection** monographs carry the actual acceptance criteria. Both require **conductivity per USP <645> Water Conductivity** and **TOC per USP <643> Total Organic Carbon**. The microbial action limits are recommended guidance: not more than 100 CFU/mL for Purified Water and not more than 10 CFU/100 mL for Water for Injection. WFI additionally carries a **bacterial endotoxin** limit of not more than 0.25 EU/mL, tested per **USP <85> Bacterial Endotoxins Test**.
