---
title: "How to Conduct a Supplier or GMP Audit: Planning, Agenda, Observations, and the Report"
description: "A working method for auditor fieldwork: scoping and planning the audit, running the opening meeting, sampling records, gathering evidence, grading findings, writing the report, and closing CAPA."
pubDate: 2026-06-20
tags: ["audits", "supplier qualification", "gmp", "auditing", "capa", "quality assurance"]
...
| Pre-approval / readiness | Ahead of a regulatory filing or technology transfer | Specific process or data package | Ties to [quality in technology transfer](/articles/quality-in-technology-transfer) |
...
You will never have time to look at everything. Allocate time to the areas where failure would most damage product quality or patient safety. A simple heat-map approach works: rate each process area by impact (effect of a failure on the product) and by likelihood/uncertainty (how much you already trust it). Spend your hours on the high-impact, high-uncertainty cells. For the underlying method, see [quality risk management](/articles/quality-risk-management).
...
1. **Introductions and roles** on both sides.
2. **Purpose and scope** restated from the plan. Confirm the supplier understands what you will and will not look at.
3. **Standard / criteria** you are auditing against.
4. **Agenda and logistics**: daily schedule, breaks, escort, access to the floor, access to records and to the people who own them.
5. **Confidentiality**: reaffirm the confidentiality agreement; clarify the photography and copying policy. Many sites prohibit photography; agree how you will capture evidence instead (record IDs, transcribed entries, supplier-provided copies).
6. **How findings will be handled**: that you will share observations as you go (no surprises at the close), the classification scheme you use, and that the closing meeting will summarize them.
7. **Safety and site rules**: gowning, hazards, induction.
...
1. **What the procedure says** (the SOP, the master batch record, the protocol).
2. **What people say happens** (interviews on the floor and in QA).
3. **What the records prove happened** (executed records, logbooks, audit trails, raw data).
...
A finding is a documented gap between what you observed and the requirement. Grading the finding drives how the supplier and your own organization respond, so it must be consistent and defensible. The widely used three-tier scheme follows the PIC/S Guidance on Classification of GMP Deficiencies (PI 040) and aligned EU GMP inspection practice (ISO 19011:2018 covers generic audit management but uses only major/minor nonconformity plus observations, not the critical/major/minor GMP grades). The scheme is:

| Grade | Definition | Typical examples |
|-------|-----------|------------------|
| **Critical** | A gap that has made, or could plausibly make, product that puts the patient at risk, or any sign of falsified or manipulated data. | Falsified data, no sterility assurance for sterile product, release of failing material, gross cross-contamination risk. |
| **Major** | A gap that has made or could make product that falls short of its specification, or a serious GMP departure on its own, or several minor gaps that together point to a system that is not in control. | No CAPA effectiveness checks, untrained operators on a critical step, missing validation for a critical process, systemic documentation gaps. |
| **Minor** | A deficiency that is neither critical nor major but is a departure from GMP. | Isolated documentation error, an SOP overdue for periodic review, a calibration label missing on a non-critical gauge. |

Grade by impact and reach, not by how annoyed you are. The decision sequence: Did it harm or could it harm a patient, or is it fraud? If yes, critical. If not, could it cause out-of-spec product, or is it a systemic breakdown, or several related minors pointing to one weak system? If yes, major. Otherwise minor. The detailed rubric, including how to roll up clusters of minors into a major, is in [audit finding classification](/articles/audit-finding-classification).
...
1. **Thank the host**, briefly. You will likely audit them again.
2. **Restate scope and standard** so findings are read in context.
3. **Present findings by grade**, most serious first, reading the objective evidence and the requirement for each. Keep it factual.
4. **Distinguish findings from your overall conclusion.** State whether the conclusion is approve, approve with conditions, or do-not-use pending remediation, and that it is preliminary until the report is issued.
5. **Hear the supplier's response.** If they produce evidence on the spot that refutes a finding, downgrade or withdraw it and note it. If they merely disagree, record their position; do not negotiate a true finding away.
6. **Set expectations for CAPA:** the response timeline, that you want root cause and not just correction, and how follow-up will work.
...
1. **Header / administrative:** supplier name and site, audit dates, type, report number and date, distribution, confidentiality marking.
2. **Scope and objective:** what was and was not covered, and why.
3. **Standard / criteria:** the references audited against, with citations.
4. **Audit team and supplier attendees.**
5. **Areas and processes covered:** with enough detail to show depth (which lines, which systems, which records traced).
6. **Summary of findings:** a table by grade with a one-line statement of each.
7. **Detailed findings:** one entry per finding (see template below).
8. **Positive observations** (optional but useful): genuine strengths, briefly. Balance builds credibility.
9. **Overall conclusion and recommendation:** approve / approve with conditions / not approved, with the rationale tied to the findings.
10. **CAPA request and timeline:** what the supplier must respond to and by when.
11. **Auditor signature(s) and date.**
...
> **Finding 03 - Major**
> **Observation:** Environmental monitoring excursions in the Grade A fill zone for the period Jan-Mar 2026 (records EM-EX-2026-014, -019, -027) were closed without an assignable root cause and without an assessment of impact on the batches filled during the affected sessions. Three of three reviewed excursions show "no root cause identified" and no batch-impact statement.
> **Requirement:** EudraLex Volume 4, Annex 1 (2022) requires investigation of EM excursions including impact assessment; the supplier's own SOP-EM-011 rev 6 section 8 requires a documented batch-impact evaluation for any Grade A excursion.
> **Risk/impact:** Sterile product may have been released without confirming that contamination control was maintained during filling. Potential patient safety impact.
> **Grade rationale:** Systemic failure to assess product impact for the highest-risk classified area; pattern across multiple events.
...
For the broader craft, see [technical writing for GxP](/articles/technical-writing-for-gxp).
...
- [Supplier and vendor qualification](/articles/supplier-vendor-qualification) - the decision logic for which suppliers to audit and how to manage approved-supplier status.
- [CDMO oversight and quality agreements](/articles/cdmo-oversight-quality-agreements) - written agreements and ongoing oversight of contract manufacturers.
- [Audit finding classification](/articles/audit-finding-classification) - the detailed rubric for grading critical, major and minor.
- [What is a CAPA](/articles/what-is-a-capa) and [CAPA effectiveness verification](/articles/capa-effectiveness-verification) - driving and closing the supplier's corrective actions.
- [Root cause analysis techniques](/articles/root-cause-analysis-techniques) and [human error in deviations](/articles/human-error-in-deviations) - testing the quality of a supplier's root cause.
- [Audit trail design and review](/articles/audit-trail-design-and-review) and [ALCOA+ in detail](/articles/alcoa-plus-deep-dive) - the data integrity evidence at the heart of fieldwork.
- [Internal audit program](/articles/internal-audit-program) and [software supplier assessment CSA](/articles/software-supplier-assessment-csa) - related audit governance and the variant for software vendors.
