...
- **FDA Guidance, "Computer Software Assurance for Production and Quality System Software," final 2024.** This is the assurance-effort-follows-risk guidance. It supports unscripted, ad hoc, and exploratory testing for lower-risk features and steers documentation effort toward where the risk is. Note the timeline carefully in interviews: it was a draft in September 2022 and was finalized in 2024. Calling the 2022 draft "final" is a tell that you have not read it.
