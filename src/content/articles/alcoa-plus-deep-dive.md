...
Where `!` indicates a gap requiring remediation. This type of matrix, when backed by evidence, is both an internal risk management tool and an inspection-ready document that demonstrates a proactive data integrity program.
