...
- **MHRA, "GXP Data Integrity Guidance and Definitions," March 2018.** Section 6.5 sets the expectation directly: data governance has to address data ownership and accountability across the full lifecycle, and cover the design, operation, and monitoring of the processes and systems that keep data compliant with the principles of data integrity, including control over both intentional and unintentional changes to data. It frames data governance as the sum of arrangements that ensure data are recorded, processed, retained, and used to assure a complete, consistent, and accurate record.
...
- **WHO Technical Report Series 1033, Annex 4, "Guideline on Data Integrity," 2021.** Carries the same lifecycle and management-ownership expectation.
...
Name the sources: MHRA 2018 DI guidance (data ownership across the lifecycle), PIC/S PI 041-1 (2021, senior management responsibility for the governance system), WHO TRS 1033 Annex 4 (2021), and the FDA 2018 CGMP DI Q&A tied to 21 CFR 210/211/212, with Part 11 and Annex 11 supplying the technical controls. For devices, the QMSR (21 CFR 820 harmonized to ISO 13485). It is a documented expectation, not a vendor concept.
