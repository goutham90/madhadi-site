...
For a modern analytical instrument, an HPLC running a CDS like Help or Chromeleon, a flow cytometer running BD FACSDiva, a ddPCR system running QuantaSoft, the instrument hardware and the software that controls it are inseparable. The raw data file generated by the system is a product of both the hardware measurement and the software's data acquisition logic. Qualifying the hardware without qualifying the software leaves an incomplete picture.
