...
| Date of approval by the study director and dated signature | Before any in-life work begins |
...
- **Retention periods** under 58.195 are tied to the regulatory fate of the article. For studies supporting a marketing application, the regulation sets retention for a defined period after approval of the application; if no application is filed, a shorter defined period applies; and there are specific provisions for specimens of negligible value such as wet tissues that have been examined. The practical rule facilities use is to keep GLP records for the longest applicable period and never destroy on assumption.
...
2. **Confirm the QAU is real.** SOPs, organization, independence from study conduct, evidence of inspections and a master schedule it maintains. Inspectors confirm the function exists without copying detailed findings (58.35(d)).
...
All raw data, protocols, specimens, and final reports go to a controlled-access archive with a designated archivist and access logging (58.190). Retention under 58.195 is tied to the regulatory fate: a defined period after marketing-application approval, a shorter period if no application is filed, with specific handling for specimens of negligible value. The safe rule is to keep for the longest applicable period.
