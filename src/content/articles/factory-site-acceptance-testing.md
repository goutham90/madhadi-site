...
The reason they matter to quality, and the reason QA reviews them at all, is reuse. The modern C&Q approach treats engineering verification and qualification as one continuum rather than two disconnected stacks of paper. ASTM E2500-25, *Standard Guide for Specification, Design, and Verification of Pharmaceutical and Biopharmaceutical Manufacturing Systems and Equipment*, and ISPE Baseline Guide Volume 5 (Commissioning and Qualification, Second Edition, 2019) both build on this idea: verification effort should be applied once, scaled to risk, and good engineering documentation should be usable as qualification evidence when it is generated under appropriate controls. FAT and SAT are the richest sources of that reusable evidence. EU GMP Annex 15 (*Qualification and Validation*, 2015 revision) makes this explicit. It allows qualification work performed during FAT to be used in the qualification program provided the results are shown to be unaffected by transport and installation, and provided the supplier and documentation are assessed.

Annex 15 puts the relevant text in its qualification section. Clause 3.4 says equipment, especially where it incorporates novel or complex technology, may be evaluated at the vendor prior to delivery, if applicable. Clause 3.6 allows documentation review and some tests to be carried out at the FAT or other stages without the need to repeat them on site at IQ or OQ, if it can be shown the functionality is not affected by transport and installation. Clause 3.7 adds that the FAT may be supplemented by the execution of a SAT following receipt of the equipment at the manufacturing site.

Clause 3.6 is the whole business case for treating FAT as a quality activity rather than a purely commercial sign-off. If you witness it, document it under controls, and show transport did not invalidate the result, you do not have to repeat that test in IQ or OQ.
...
Not directly. They are commissioning/engineering activities under your contract and C&Q program. But EU GMP Annex 15 (2015) explicitly recognizes them and allows FAT work to be used in the qualification program if results are shown to be unaffected by transport and installation and the supplier/documentation are assessed. ASTM E2500-25 and ISPE Baseline Guide Volume 5 frame the reuse model.
