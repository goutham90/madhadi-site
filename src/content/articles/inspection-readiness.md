...
**Know your user account status.** Be able to demonstrate that there are no shared accounts and that all accounts have appropriate access levels. Have the user account reports ready — active accounts, historical account activity, access control settings.
...
**Managing the day:** The inspector controls the schedule. Follow their lead on pace, areas of focus, and additional requests. The front-room host's job is to facilitate access, not to redirect attention.
