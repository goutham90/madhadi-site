...
A remote evaluation carried out by the sponsor's central team (data managers, statisticians, central monitors) using aggregated, cross-site data. It is the analytical engine of RBM. ICH E6(R2) 5.18.3(b) lists what centralized monitoring can accomplish: identifying missing or inconsistent data, data outliers and trends, range and consistency checks, detecting systematic or significant errors at a site or across sites, and analyzing site characteristics and performance metrics. It can also select sites or processes for targeted on-site review.
