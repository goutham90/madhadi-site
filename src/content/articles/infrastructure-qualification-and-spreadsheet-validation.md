...
- **Blank-cell math.** A formula averages a column that sometimes contains blanks, and Excel's treatment quietly biases the result; never tested with empty inputs.
