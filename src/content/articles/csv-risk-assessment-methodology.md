...
CSA is the assurance approach FDA's 2022 draft, finalized in 2024, asks you to apply: risk-based, with rigor concentrated on functions that affect patient safety and product quality, and a spectrum of activities from scripted down to ad hoc. CSV is the broader validation discipline. CSA is not "less validation," it is less testing where risk is low and more genuine challenge where risk is high. Say that plainly; interviewers are checking whether you read CSA as a shortcut, which it is not.
