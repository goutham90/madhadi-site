...
| Sample status | 312,000 | 312,000 | 0 | 311,994 | 6 (null status, corrected then re-migrated) | Sampled, 0 critical defects |
| Audit trail records | 1,204,330 | 1,204,330 | 0 | 1,204,330 | 0 | Completeness 100%, render check pass |

The arithmetic has to close: in scope minus rejected (then resolved) equals migrated, and migrated plus excluded equals baseline. The six rejected status records show the right behaviour: they were caught, investigated, corrected, and re-migrated, not silently lost.
...
Retention periods come from the predicate rules and applicable regulations, not convenience. Drug GMP records under 21 CFR 211.180 generally must be retained for at least one year after a batch's expiry date (longer for certain products and for some records). Device records under 21 CFR 820 are retained for a period tied to the device's expected life but not less than two years from release. Nonclinical study records fall under 21 CFR 58. Clinical essential documents follow ICH E6(R2) good clinical practice retention expectations. Map every migrated and archived data class to its retention requirement and confirm the new home satisfies it for the full duration. See [stability programs and ICH](/articles/stability-programs-ich) for one common driver of retention horizons and [GLP under 21 CFR 58](/articles/glp-21-cfr-58-nonclinical) and [ICH E6 good clinical practice](/articles/ich-e6-good-clinical-practice) for others.
